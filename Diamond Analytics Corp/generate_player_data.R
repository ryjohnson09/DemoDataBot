...
player_data <- player_data %>%
  ...
  # Take first 50 players to keep dataset small
  slice_head(n = 50)

# Add header comment to CSV
header_comment <- "# Synthetic Baseball Player Analytics Data - AI Generated for Demonstration
